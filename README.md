...
The template file is a JSON file which codifies the infrastructure. The template file is passed through a rewriter which will re-write the structure, and allows you to do some basic programming in JSON format.
...
| Attribute Key | Attribute Value Type | Description                             |
|---------------|----------------------|-----------------------------------------|
| Key           | string               | The key of the property being mapped.   |
| Value         | any                  | The value of the property being mapped. |
...
An object with a single key of `@Spread` and a value of an array of arrays is recognized by this rewritter. All of the arrays within the array will be combined into a single array.
...
An object with a single key of `@Spread` and a value of an array of arrays is recognized by this rewritter. All of the objects within the array will be combined into a single object.
